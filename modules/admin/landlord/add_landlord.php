<h3 class="blank1">Landlord | Add A Landlord</h3>
<div id="landlord_add_status"></div>
        <form class="form-horizontal" id="add_landlord_frm" action="config/add_landlord.php">
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" name="firstname" class="form-control1" id="focusedinput" placeholder="landlord's First Name">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" name="lastname" class="form-control1" id="focusedinput" placeholder="landlord's Last">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="email" name="email" class="form-control1" id="focusedinput" placeholder="landlord's Email Address">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="number" name="idno" class="form-control1" id="mediuminput" placeholder="landlord's National Identity Number">
            </div>
          </div>
